 ...
 *
 * Must be called *after* public/clear-cache.php (see that file for why
 * cache-busting isn't done here, in-process): this request needs to boot a
 * genuinely fresh kernel against the already-cleared cache, which is only
 * true if the cache-clear happened as its own prior request.
 */
#[Route('/api/internal')]
